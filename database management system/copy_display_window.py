...
class Auth_admin(QWidget):
    ...
    def get_admin_details(self):
       ...
       flie_open = open(r'C:\Users\ACER\Desktop\database_manager\admin_details.txt', 'r')
...
#       self.rank_title_edit.setPlaceholderText("Enter Army number")
   ...
   def add_image(self):
       ...
       new_path = r'C:\Users\ACER\Desktop\database_manager\images\\'+ self.format_this(str(int(self.army_number)))+ '_' + 'officer' + '.png'
...
#        self.rank_title_edit.setPlaceholderText("Enter Army number")
   ...
   def add_image(self):
       ...
       source_file = self.image
       self.get_image = QImage(filePath)
       new_path = r'C:\Users\ACER\Desktop\database_manager\images\\'+ self.format_this(str(int(self.army_number)))+ '_' + 'soldier' + '.png'
