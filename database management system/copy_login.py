...
from copy_display_window import display_window
       ...
       if self.confirm_details() == True:
           ...
           try:
              ...
              if details == 'not found':
                 ...
                 print(details)
                 get_image_directory = r'C:\Users\ACER\Desktop\database_manager\images\\' + self.format_this(str(self.lineedit_name.text()))+ '_' + self.army_type + '.png'
