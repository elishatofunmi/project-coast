...
from database_display import display_details
...
class login(QWidget):
    ...
    def display_login_details(self):
        ...
        self.lineedit_name.setPlaceholderText("Enter your service number")
    ...
    def log_in(self):
        if self.confirm_details() == True:
            ...
            try:
               self.search_person(name, user_type = 'soldier')
               
            except NameError:
               self.search_person(name, user_type = 'officer')
    ...
    def search_person(self,k, user_type = 'soldier'):
       display = display_details()
       if user_type == 'soldier':
          display = display.display_details(k, user_id = 'soldier')
          
       elif user_type == 'officer':
          display = display.display_details(k, user_id = 'officer')
